...
function Flatpickr(element, config) {
	...
	function bind() {
		...
		if (!self.config.noCalendar) {
			...
			if (path == 'booking_activity_details.html') {
				self.days.addEventListener("click", function(){
					getActivityList()
				});
			}else if (path == 'booking_venues_details.html') {
				self.days.addEventListener("click", function(){
					getBookingTimeList()
					var now = $('.flatpickr-input').attr('data-default-date')
					var clickTime = $('.flatpickr-input').val()
					now = timestamp(now)
					clickTime = timestamp(clickTime)
					if (clickTime < now) {
						$('.c-venues__left--button .button').addClass('disabled')
					}else{
						$('.c-venues__left--button .button').removeClass('disabled')
					}
				});
			}
		}
...
if (tem_lang == 'zh') {
	var shortWeek = ["周日", "周一", "周二", "周三", "周四", "周五", "周六"]
	var longWeek = ["周日", "周一", "周二", "周三", "周四", "周五", "周六"]
	var shortMonths = ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"]
	var longMonths = ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"]
}else if (tem_lang == 'en') {
	var shortWeek = ["Sun", "Mon"," Tue", "Wed"," Thu", "Fri"," Sat"]
	var longWeek = ["Sunday", "Monday"," Tuesday", "Wednesday"," Thursday", "Friday"," Saturday"]
	var shortMonths = ["Mon", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]
	var longMonths = ["Month", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]
}else if (tem_lang == 'hk') {
	var shortWeek = ["周日", "周壹", "周二", "周三", "周四", "周五", "周六"]
	var longWeek = ["周日", "周壹", "周二", "周三", "周四", "周五", "周六"]
	var shortMonths = ["壹月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十壹月", "十二月"]
	var longMonths = ["壹月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十壹月", "十二月"]
}
