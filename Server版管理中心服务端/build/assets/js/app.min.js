...
$(document).ready(function() {
  return $('[data-js-navMobile]').NavMobile();
});
...
NavMobile = (function(superClass) {
  extend(NavMobile, superClass);

  function NavMobile() {
    return NavMobile.__super__.constructor.apply(this, arguments);
  }

  NavMobile.prototype.init = function() {
    NavMobile.__super__.init.call(this);
    this.el.mobileLeftBtn = this.el.target.find('.c-nav__mobile--left');
    this.el.mobileRightBtn = this.el.target.find('.c-nav__mobile--right');
    return this.events();
  };

  NavMobile.prototype.events = function() {
    this.el.mobileLeftBtn.click(function() {
      return $('.c-nav__menu').toggleClass('is-active');
    });
    return this.el.mobileLeftBtn.click(function() {
      return $('.c-nav__mobile--user').toggleClass('is-active');
    });
  };
...
$.rstPlugin(NavMobile, 'NavMobile', true);
